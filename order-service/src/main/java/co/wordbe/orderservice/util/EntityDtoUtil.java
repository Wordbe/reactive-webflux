package co.wordbe.orderservice.util;

import co.wordbe.orderservice.dto.*;
...
public class EntityDtoUtil {
    ...
    public static PurchaseOrder getPurchaseOrder(RequestContext requestContext) {
        ...
        OrderStatus orderStatus = TransactionStatus.APPROVED == status ? OrderStatus.COMPLETED : OrderStatus.FAILED;
